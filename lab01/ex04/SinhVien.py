class SinhVien:
    def __init__(self, id, name, sex, major, diemTB):
        ...
        def soLuongSinhVien(self):
            svId = self.listSinhVien.__Ien__()
        ...
        def updateSinhVien(self, ID):
            ...
            def sortByID(self)
                self.listSinhVien.sort(key=lambda x: x._id, reserve=False) 

            def sortByName(self)
                self.listSinhVien.sort(key=lambda x: x._name, reserve=False)  

            def sortByDiemTB(self)
                self.listSinhVien.sort(key=lambda x: x._diemTB, reserve=False)
